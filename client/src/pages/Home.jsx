        ...
        <Col>
          <Card className="original-site-card">
            ...
            <Card.Body>
              ...
              <Card.Text>
                Take a step back into history and view the original Blockbuster
                website. It may not be up and running, but it is for sure going
                to induce some nostalgia.
              </Card.Text>
              <Button
                variant="primary"
          ...
          <Card className="card-box-shadow" style={{ width: "24rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                them into your very own collection once you become a Blockbuster
                member.
              </Card.Text>
              <Button variant="primary" href="/search-books" target="_blank">
                Search Book Catalog
              </Button>
            </Card.Body>
          </Card>
        ...
        <Col className="membershipCol">
          <Card className="card-box-shadow" style={{ width: "24rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Try out our movie catalog with any movie you can think of. Find
                a large variety of information with each movie! You can also
                save the movie to your favorites list so you never forget about
                them!
              </Card.Text>
              <Button variant="primary" href="/search-movies" target="_blank">
